...
const SwiperItems = [
    {
        backgroundColor: "#fff",
        title: "Report Animal Rescue",
        subtitle: "Report A Voiceless Animal in Distress and Get Help!",
    ...
    },
    {
        ...
        subtitle: "Help in Animal Rescues Nearby & Create an Impact!",
    ...
    {
        backgroundColor: "#fff",
        title: "Find Trusted Veterinaries",
        subtitle: "Get in Touch with Verified Vets You Can Trust!",
    ...
    },
    {
        ...
        subtitle: "Get in Touch with Animal Welfare Organisations! ",
...
const OnBoardingScreen = () => {
    ...
    return (
            <Onboarding
                ...
                titleStyles={{ fontSize: 18,textTransform:"uppercase", paddingHorizontal: 10, color: colors.fontGray, fontFamily: FontVariants.weight700 }}
                subTitleStyles={{ paddingHorizontal: 9, fontSize: 35, fontFamily: FontVariants.weight800, textAlign: "left", color: colors.font }}
                pages={SwiperItems} />
    )
}
