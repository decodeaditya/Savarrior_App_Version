            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: colors.white }}>
                <View style={{ backgroundColor: colors.white, paddingHorizontal: 20, justifyContent: 'center', height: "100%" }}>
                  ...
                  <View
                    ...
                    <Pressable style={{ padding: 10, marginTop: 10 }} onPress={() => navigation.navigate("Register")}>
                        <Text style={{ textAlign: "center", fontFamily: FontVariants.weight600, fontSize: 16 }}>Don't Have A Account? <Text style={{ color: colors.fontGray, textDecorationColor: colors.black, textDecorationLine: "underline" }}>Sign Up</Text></Text>
                    </Pressable>
                </View>
            </SafeAreaView>
        </>
